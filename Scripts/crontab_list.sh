...
#环境测试
0 9,22 * * * node /scripts/jd_api_test.js >> /scripts/logs/jd_api_test.log 2>&1
#点点券
...
#京喜工厂助力
32 */2 * * * node /scripts/jd_dreamFactory_help.js >> /scripts/logs/jd_dreamFactory_help.log 2>&1
#京东家庭号
